        ...
        <div class="w-full flex py-12 mx-auto">
            <div class="max-w-8xl mx-auto grid grid-cols-3 py-4">
                ...
                <div class="col-span-2 mb-6 py-4">
                    <h2 class="text-2xl font-extrabold">Identificar el proyecto</h2>
                    <p class="my-4 text-lg text-gray-500">A continuación configurará un nombre para identificar el proyecto.</p>
                    <p class="mb-4 text-lg font-normal text-gray-500">Considere un nombre que pueda servir para identificar el proyecto, que lo describa o lo ubique.</p>
                </div>
                    ...
                    <div class="grid grid-cols-6 pt-6">
                        <div class="col-span-4 col-start-2">
                            <div class="my-6 px-12 mx-auto">
                                <label for="NOMBRE_PROYECTO" class="block mb-2 text-lg font-medium text-gray-900">Indique el nombre del proyecto.</label>
                                <div class="inline-flex mx-auto w-full rounded-md shadow-sm">
                                    <button wire:click="resetNombreProyecto" type="button" class="px-6 py-2 text-base font-medium text-white bg-red-700 rounded-s-lg hover:bg-red-800">
                                        <i class="fa-solid fa-arrow-rotate-right"></i>
                                    </button>
                                    <input type="text" id="NOMBRE_PROYECTO" name="NOMBRE_PROYECTO" wire:model="NOMBRE_PROYECTO" class="block w-full p-4 text-gray-900 border border-gray-300 rounded-e-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500">
                                </div>
                            </div>
            ...
            <div class="max-w-6xl mx-auto py-4 ">
                <div class="mt-1 min-w-full md:mt-0 bg-white p-4">
                    <div class="space-y-6 bg-white px-4 py-1 sm:p-6">
                        ...
                        <h2 class="text-2xl font-extrabold text-center">Seleccionar ubicación del proyecto</h2>
                        <p class="@if($seleccionarUbicacion==true) hidden @endif my-4 text-lg text-gray-500">A continuación podrá seleccionar la ubicación del proyecto, comenzando por la población, la direccion y el código.</p>
                        ...
                        <div class="py-6">
                            ...
                            <div class="grid grid-cols-3">
                                <div class="col-span-1 px-4 py-6 mt-6">
                                    <label for="POBLACION" class="block mb-2 text-lg font-medium text-gray-900">Indique el la población del proyecto.</label>
                                ...
                                <div class="col-span-1  px-4 py-6 mt-6">
                                    <label for="DIRECCION" class="block mb-2 text-lg font-medium text-gray-900">Indique la dirección del proyecto.</label>
                                ...
                                <div class="col-span-1  px-4 py-6 mt-6">
                                    <label for="CÓDIGO" class="block mb-2 text-lg font-medium text-gray-900">Indique código del proyecto.</label>
                                    <input type="text" name="codigo" id="codigo" wire:model="CODIGO_PROYECTO" class="my-5 block w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded leading-tight focus:outline-none focus:shadow-outline" placeholder="Dirección">
                                </div>
                            </div>
                            <div class="my-6 px-12 mx-auto text-center justify-center py-6">
                                <div class="inline-flex mx-auto rounded-md shadow-sm mt-4" role="group">
        ...
        <div class="w-full py-12 mx-auto">
            <div class="max-w-8xl mx-auto grid grid-cols-3 py-2 ">
                ...
                <div class="col-span-2 mb-2 py-2">
                    <h2 class="text-2xl font-extrabold ">Configuración inicial del proyecto</h2>
                    <p class="my-4 text-lg text-gray-500">A continuación comprobará si la caracterización del proyecto es la adecuada.</p>
                    <p class="mb-4 text-lg font-normal text-gray-500 ">Ha configurado el nombre de proyecto y lo ha ubicado para generar un código para de este proyecto.</p>
            ...
            <div class="min-w-full grid grid-cols-6 py-2 px-6">
                <div class="col-span-3 py-2 px-6">
                        <div class="w-full text-gray-900 bg-white border border-gray-200 rounded-lg" >
                            ...
                            <button type="button" wire:click="generarCodigoProyecto" class="relative inline-flex items-center w-full px-4 py-4 text-lg font-medium rounded-b-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 ">
                                <i class="fa-solid fa-code mr-4"></i>
                                <span class="font-bold px-4">CODIGO PROYECTO:</span>
                                <span class="text-gray-500 italic font-medium">{{ $CODIGO_PROYECTO }}</span>
                            </button>
            ...
            <div class="grid grid-cols-6 py-3 px-12">
                ...
                <div class="col-span-2 py-2 mx-2">
                    <button
                            ...
                            > <i class="fa-solid fa-signature"></i> <br> Cambiar nombre proyecto</button>
                </div>
                <div class="col-span-2 py-2  mx-2">
                    <button
                            ...
                            ><i class="fa-solid fa-map-location-dot"></i> <br> Cambiar ubicación proyecto</button>
                </div>
                <div class="col-span-2 py-2  mx-2">
                    <button type="button"
                    ...
                    class="relative block  w-full items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 ">
                        <div class="text-center px-4">
                            ...
                            <br>
                              <span class=""> Resumen Proyecto</span>
                        </div>
                    </button>
                </div>
            </div>
        ...
        <div class="w-full py-12 mx-auto">
            <div class="max-w-8xl mx-auto grid grid-cols-3 py-2 ">
                ...
                <div class="col-span-2 mb-2 py-1">
                    <h2 class="text-2xl font-extrabold ">Guardar el proyecto</h2>
                    <p class="my-4 text-lg text-gray-500">Esta es la configuración del proyecto que va a crear.</p>
                    <p class="mb-4 text-lg font-normal text-gray-500 ">Considere que a partir de la creación del proyecto podrá gestionar muchas opciones más.</p>
                    <p class="mb-4 text-lg font-normal text-gray-500 ">Si la información básica es correcta, puede guardar el proyecto para continuar con la creación del mismo.</p>
                    <hr class="max-w-xl h-1 mx-auto mt-4 bg-green-600 border-0 rounded md:my-10 ">
                </div>
            </div>
            <div class="p-12 mt-8 mb-3  max-w-8xl mx-auto border-2 border-gray-200 rounded-md">
                <h5 class="mb-4 text-xl font-extrabold  text-green-500">¿Qué podrás hacer en el proyecto?</h5>
                <ol
                ...
                <li style="min-width:20%">
                    ...
                    <p class="py-4 px-3 text-gray-600">
                        Añadir edificios al proyecto y completar la información que define cada uno de ellos
                    </p>
                    </div>
                </li>
                ...
                <li style="min-width:20%">
                    ...
                    <p class="py-4 px-3 text-gray-400 italic leading-7">
                        Vincule los gestores o usuarios  relacionados con el proyecto indicando su principales datos
                    </p>
                    </div>
                </li>
                </ol>
                            ...
                            <div class="grid grid-cols-6">
                                <div class="col-span-3 text-center">
                                    <div class="flex justify-center items-center mb-4">
                                        ...
                                        <label for="checkform-checkbox" class="ms-2 text-medium font-medium text-gray-900">¿Quiere guardar el proyecto?</label>
                                    </div>
                                </div>
                                <div class="col-span-3">
                                    <button type="button"
                                    wire:click="guardarProyecto"
